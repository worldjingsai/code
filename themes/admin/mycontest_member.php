...
<span class="chevron">&nbsp;›&nbsp;</span> 届数<?php echo $conf['session'];?>
</div>
<div class='cell'>

<div class="cell">
<form method="get"  class="form-horizontal" action="<?php echo site_url('admin/contests/team_list/'.$conf['contest_id'].'/'.$conf['session'])?>">
  			<fieldset>
...
<?php }?>
<td class='w100'>
<a href="<?php echo site_url('admin/contests/team_info/'.$v['team_id']);?>" class="btn btn-primary btn-sm">详情</a>
<?php if ($v['result_file']) {?><a href="<?php echo site_url('admin/contests/result_file/'.$v['team_id']);?>" class="btn btn-primary btn-sm">作品</a><?php }?>
